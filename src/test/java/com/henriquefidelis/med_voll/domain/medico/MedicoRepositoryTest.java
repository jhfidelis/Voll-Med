...
import com.henriquefidelis.med_voll.domain.consulta.Consulta;
...
public class MedicoRepositoryTest {
    ...
    void testEscolherMedicoAleatoriamenteCenario1() {
        //GIVEN ou ARRANGE
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);

        var medico = cadastrarMedico("Medico", "medico@vollmed.com.br", "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Paciente", "paciente@email.com", "12345678955");
        cadastrarConsulta(medico, paciente, proximaSegundaAs10);;

        //WHEN ou ACT
        var medicoLivre = medicoRepository.escolherMedicoAleatoriamente(Especialidade.CARDIOLOGIA, proximaSegundaAs10);
    ...
    void testEscolherMedicoAleatoriamenteCenario2() {
        //GIVEN ou ARRANGE
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);
